# ========================================================================
# main.R    -   Naia Ormaza Zulueta   -  Apr 2022
# In this file:
...
water <- rast("/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Codes and Data/Rasters/water.tif")
...
# Absolute threshold computations
df$air <- 0
df$water <- 0
df$biodiv <- 0
df$safecl <- 0
for (i in 805208:dim(df)[1]) {
  if(df$`V5GL02.HybridPM25c_0p10.Global.202001-202012`[i]>35){df$air[i] <- 1}
  if(df$ws_avg[i]>1.5){df$water[i] <- 1}
...
# Save Data Frame
save(df,file="/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Codes and Data/R/Data/stack_layers.Rdata")
...
# write rasters
writeRaster(raster_HRV, filename="/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/HRV_2.tif", overwrite=TRUE)
writeRaster(rasterx, filename="/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/HRV_Layer1.tif", overwrite=TRUE)
writeRaster(rastery, filename="/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/Population_Layer2.tif", overwrite=TRUE)

rasterx <- rast("/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/HRV_Layer1.tif")
rastery <- rast("/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/Population_Layer2.tif")
...
ggsave(plot = fig_global,
       filename = "BivariatePlot_Global_ggsave.png",
       device = "png", path = "/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/",
       width = 6, height = 7, units = "in",
       dpi = 320)

ggsave(plot = fig_eur,
       filename = "BivariatePlot_Europe.png",
       device = "png", path = "/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/",
       width = 6, height = 7, units = "in",
       dpi = 320)

ggsave(plot = fig_na,
       filename = "BivariatePlot_NorthCentralAmerica.png",
       device = "png", path = "/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/",
       width = 6, height = 7, units = "in",
       dpi = 320)

ggsave(plot = fig_sea,
       filename = "BivariatePlot_SEAsia.png",
       device = "png", path = "/Users/naiacasina/Documents/IDEA SECOND/Sem 3/ENVS/Results/",
       width = 6, height = 7, units = "in",
       dpi = 320)
